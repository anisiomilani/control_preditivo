...
//float calcular_q_filtrado(volatile float *entrada_filtrada,volatile float *saida_q_filtrada, int entrada_atual, int entrada_ant, int saida_ant);
//float calcular_v_filtrado(volatile float *entrada,volatile float *saida_filtrada,int entrada_atual, int entrada_ant,int saida_ant_1, int saida_ant_2);
#endif/* FUNCOES_H_ */
